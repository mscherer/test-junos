[![Build Status](http://jenkins.testing.ansible.com/buildStatus/icon?job=Test_Junos_Modules)](http://jenkins.testing.ansible.com/view/Ansible/job/Test_Junos_Modules/)
